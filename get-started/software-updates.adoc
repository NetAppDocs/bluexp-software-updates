...
*ONTAP systems*: You can use the BlueXP software updates service only if you are running ONTAP 9.10 or the later version. If you are on an earlier version of ONTAP, you need to link:https://docs.netapp.com/us-en/ontap/upgrade/index.html[manually update your storage systems].
